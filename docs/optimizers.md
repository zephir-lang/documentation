...
This file must be added at a special section in the [config.json][config] file:
...
Check the complete source code of this example [here][example]

[config]: config.md
[example]: https://github.com/zephir-lang/zephir-samples/tree/master/ext-optimizers
